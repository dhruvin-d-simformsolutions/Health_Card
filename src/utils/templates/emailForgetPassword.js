const forgetpassmsg = (firstname,lastname,username,password) => {
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text" esd-links-color="#666666" align="center">
                                                                                            <p style="font-size: 14px;">Contact us: <a target="_blank" href="mailto:sgh000437@gmail.com" style="font-size: 14px; color: #666666;">sgh000437@gmail.com</a></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
